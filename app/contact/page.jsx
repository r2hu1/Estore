...
export default function Page() {
    return (
        <div className="px-8 md:px-20 py-20">
            ...
            <form className="grid gap-2 max-w-lg mt-10 mx-auto">
                <Label htmlFor="name">Name</Label>
                <Input type="text" placeholder="Tony Stark" id="name" className="mb-3"></Input>
                <Label htmlFor="email">Email</Label>
                <Input type="email" placeholder="tony@stark.com" id="email" className="mb-3"></Input>
                <Label htmlFor="message">Message</Label>
                <Textarea placeholder="I need a custom website..." id="message" className="mb-3 min-h-[130px]"></Textarea>
