    ...
    return (
        <div className="border rounded-md w-fit bg-background dark:bg-secondary p-1 transition hover:scale-105">
            <Link href={link} className="relative hover:">
                <img width={300} height={300} className="rounded-md md:h-[200px] md:w-[300px] w-full h-full min-h-[200px] min-w-[335px] md:min-w-0 max-h-[200px] max-w-[350px]" src={image} alt="thumbnail"></img>
            </Link>
            <Link href={link}>
